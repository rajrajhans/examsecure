            ...
            {isWebCamReady ? (
                  ...
                  <Fragment>
                    ...
                    >
                      ...
                      <ul className={"instructionsBoxList"}>
                        <li>
                          Ensure your face is clearly visible in the webcam.
                        </li>
                        <li>
                          Do not wear cap, scarf, goggles / sunglasses,
                          headphones, earphones.
                        </li>
                        <li>
                          Do not attempt to hide your face during the test.
                        </li>
                        <li>
                          Ensure that no one else is sitting with you during the
              ...
              <Fragment>
                ...
                >
                  ...
                  <ul className={"instructionsBoxList"}>
                    <li>
                      When prompted, you need to click <i>Allow</i> to use the
                      application with your webcam.
                    </li>
                    <li>
                      If you don't see the dialog, try{" "}
                      <a href={currentUrl}>opening the application</a> in a new
                      incognito window, or review your webcam settings on your
                      browser.
                    </li>
                    <li>
